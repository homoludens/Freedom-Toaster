...
class Helper:
    def __init__(self):
        ...
        gradient2 = QLinearGradient(QPointF(50, -20), QPointF(80, 20))
        gradient2.setColorAt(0.0, QColor(0xa6, 0xce, 0x39))
        gradient2.setColorAt(1.0, Qt.white)
        

        self.background = QBrush(QColor(0, 0, 0, 0))
        self.circleBrush = QBrush(gradient)
        self.circlePen = QPen(QBrush(gradient2), 0.0)
        self.circlePen.setWidth(0)
        self.textPen = QPen(QColor(0, 0, 0, 150))
        self.textFont = QFont()
    ...
    def paint(self, painter, event, elapsed):
        ...
        rectangle=QRectF(0.0, 0.0, 50.0, 50.0);
